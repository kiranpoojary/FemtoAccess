...
$emailid="to@mail.com";    //recipient mailID
$sub="Nokia-Femto Booking";     //Subject
$bodyContent="Hi User";         //Body content
...
$mail->Username = "";                       // SMTP username: string before @symbol in mailID
$mail->Password = "";                       // SMTP password
$mail->SMTPSecure = 'tls';                  // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                          // TCP port to connect to
$mail->setFrom("from@mail.com", 'Nokia(IN/Bangaluru)');     
