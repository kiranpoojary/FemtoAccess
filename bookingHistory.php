              ...
              <div class="sparkline13-list">
                <div class="sparkline13-hd">
                  <div class="main-sparkline13-hd">
                    <h1>Booking History Of Femto FSN:<?php echo " ".$_SESSION["serialNo"]; ?>
              ...
              <div class="sparkline13-graph">
                <div class="datatable-dashv1-list custom-datatable-overright">
                  ...
                  <tbody>
                   ...
                   {
                    $sql = "SELECT * FROM femtobookings where femtoFSN='$_SESSION[serialNo]' AND bookingdate<'". $TodayDate ."' ORDER BY bookingdate DESC";
                    ...
                    {
                      echo "<b><font style='color:red'>No Booking History Found<font><b>";
                    }
                  }
