...
<head>
    ...
    <script type="text/javascript">
        function success_report($tt,$txt,$ty)
        {
            swal({
                title: $tt,
                text: $txt,
...
session_start();
//remove comments bellow to enable mail service
/*
...
$decryptedPassword=openssl_decrypt ($encryption, $ciphering,  
    $decryption_key, $options, $decryption_iv); 

$emailid=$_SESSION["logedUser"];
$sub="Nokia-Femto Booking";
$h1="";
$slots="";
$fsn=$_SESSION["fsn"];
...
if(substr_count($slots,"A")>0 )
    $newslots.="00:00-02:00</br>";
if(substr_count($slots,"B")>0)
  $newslots.="02:00-04:00</br>";
if(substr_count($slots,"C")>0)
  $newslots.="04:00-06:00</br>";
if(substr_count($slots,"D")>0)
  $newslots.="06:00-08:00</br>";
if(substr_count($slots,"E")>0)
  $newslots.="08:00-10:00</br>";
if(substr_count($slots,"F")>0)
  $newslots.="10:00-12:00</br>";
if(substr_count($slots,"G")>0)
  $newslots.="12:00-14:00</br>";
if(substr_count($slots,"H")>0)
  $newslots.="14:00-16:00</br>";
if(substr_count($slots,"I")>0)
  $newslots.="16:00-18:00</br>";
if(substr_count($slots,"J")>0)
  $newslots.="18:00-20:00</br>";
if(substr_count($slots,"K")>0)
  $newslots.="20:00-22:00</br>";
if(substr_count($slots,"L")>0)
  $newslots.="22:00-00:00</br>";


if(strcmp($_SESSION["mailType"], "Booked")==0)
{
    $h1="Your Femto Booking Successful";
    $bodyContent = '<h4>'.$h1.'</h4>';
    $bodyContent .= 'Femto FSN : '.$fsn.'<br>Booked Date : '.$bookedDate.'<br><b>Booked Time Slots </b> '.$newslots.'</br>';

}
if(strcmp($_SESSION["mailType"], "Updated")==0)
{
    $h1="Your Femto Booking Updated";
    $bodyContent = '<h4>'.$h1.'</h4>';
    $bodyContent .= '<Booking ID : '.$_SESSION["BId"].'<br>Femto FSN : '.$fsn.'<br>Booked Date                 : '.$bookedDate.'<br><b>Booked Time Slots </b> '.$newslots.'</br>';

}
if(strcmp($_SESSION["mailType"], "Canceled")==0)
{
    $h1="Your Femto Booking Canceled";
    $bodyContent = '<h4>'.$h1.'</h4>';
    $bodyContent .= 'Booking ID : '.$_SESSION["BId"].'<br>Femto FSN : '.$fsn.'<br>Booked Date       : '.$bookedDate;
...
$mail->Username = "kiranpjr97";          // SMTP username
$mail->Password = $decryptedPassword; // SMTP password
$mail->SMTPSecure = 'tls';                  // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                          // TCP port to connect to
$mail->setFrom("kiranpjr97@gmail.com", 'Nokia(IN/Bangaluru)');
$mail->addReplyTo($emailid, 'Femto Booking');
...
//$bodyContent .= '<br>Femto FSN : '.$fsn.'<br>Date : '.$bookedDate.'<br><b>Booked Time Slots </b> '.$newslots.'</br>';
    ...
    if(strcmp($_SESSION["mailType"], "Booked")==0)
{
  ...
  'success_report("Booking Successful.","Sending mail failed", "success");',
  '</script>';
...
{
    echo '<script type="text/javascript">',
  'success_report("Booking Successfuly Updated.","Sending mail failed", "success");',
  '</script>';
...
{
     echo '<script type="text/javascript">',
  'success_report("Booking Canceled.","Sending mail failed", "success");',
  '</script>';
}
...
{
    echo '<script type="text/javascript">',
   'success_report("Booking Successful","", "success");',
   '</script>';
...
{
    echo '<script type="text/javascript">',
   'success_report("Booking Updated successfully","", "success");',
   '</script>';
...
{
    echo '<script type="text/javascript">',
   'success_report("Booking Canceled","", "success");',
   '</script>';
}
