            ...
            <div class="sparkline13-list">
              <div class="sparkline13-hd">
                <div class="main-sparkline13-hd">
                  <h1>All<span class="table-project-n"> Your</span> Bookings</h1>
                </div>
              </div>
                ...
                <div class="datatable-dashv1-list custom-datatable-overright">
                  ...
                  <thead> 
                    <tr>
                      ...
                      <th data-field="sts" data-editable="false">Booking Status</th>
                  ...
                  <tbody>
                   ...
                   {
                    $sql = "SELECT * FROM femtobookings where userID='$_SESSION[logedUser]' ORDER BY bookingdate DESC";
                    ...
                    if ($result->num_rows > 0)
                    {
                      ...
                      while($row = $result->fetch_assoc())
                      {
                        ...
                        {
                          echo "<td ><a class='btn btn-primary' href='sessionAdderBookingCancel.php?bookingID=".$row["bookingID"]." &femtoFSN=".$row['femtoFSN']."&bookdate=".$row['bookingdate']." &purpose=".$row['purpose']." &bookingSts=".$row['status']."&style='margin-right:16px'> Update Slots </a></td>";

                        }
                        else
                        {
                          echo "<td ><a class='btn btn-primary' href=''> Can't Update </a></td>";
