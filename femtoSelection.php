...
else
{
    ...
    $checkAdmin = "SELECT * FROM adminusers WHERE userID='$userID'";
    $checkResult = $con->query($checkAdmin);
    ...
    if ($checkResult->num_rows > 0)
    {
        ...
        while($row = $checkResult->fetch_assoc()) {
            ...
            $_SESSION['adminAdder']=$row["addedBy"];
        }
            ...
            <nav class="navbar navbar-default">
              <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                  <li class="active"><a href="femtoSelection.php">Femto List</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                if($_SESSION["adminUser"])
                {
                    ...
                    ?>
                    <li><a href="../FemtoAccess/Admin/"><span class="fa fa-cogs"></span>&nbsp;&nbsp;Admin Access</a></li>
                    <?php
                }
...
<marquee direction="right"><label style="color: red"><b>NEW:</b></label>Click On Femto FSN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label style="color: red"><b>NEW:</b></label>Click On Femto FSN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label style="color: red"><b>NEW:</b></label>Click On Femto FSN&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label style="color: red"><b>NEW:</b></label>Click On Femto FSN</marquee>
                                ...
                                <tbody>
                                   ...
                                   if ($result->num_rows > 0)
                                   {
                                    ...
                                    while($row = $result->fetch_assoc())
                                    {
                                        ...
                                        echo "<td><a href='femtoDetails.php?femtoFSN=".$row['FSN']."&femtoIP=".$row['femtoIP']."'>".$row["FSN"] ."</a></td>";

                                        echo "<td>".$row["vendor"]."</td>";
                                        echo "<td>".$row["varient"]."</td>";

                                        $sql2 = "SELECT FirstName,LastName FROM femtousers WHERE userID IN(SELECT userID FROM femtobookings WHERE bookingdate='$TodayDate' AND femtoFSN='$row[FSN]' AND slot LIKE '%$currentSlot%')";
                                        ...
                                        if ($result2->num_rows > 0)
                                        {
                                            ...
                                            {
                                                $value=$row2["FirstName"]." ".$row2["LastName"];
                                            }
                                        }
                                        else
                                        {
